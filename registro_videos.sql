...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2023 a las 14:11:25
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Apellidos i nombre de los actores';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Registro de Papel en la Pelicula\r\nActor Principal\r\n -&#';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Datos de Alquiler de la Pelicula al Socio';

--
-- Volcado de datos para la tabla `alquiler`
--

INSERT INTO `alquiler` (`ALQ_ID`, `SOC_ID`, `PEL_ID`, `ALQ_FECHA_DESDE`, `ALQ_FECHA_HASTA`, `ALQ_VALOR`, `ALQ_FECHA_ENTREGA`) VALUES
(1, 1, 1, '2023-05-06', '2023-05-10', 50.00, '2023-05-11');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Nombre del director de la pelicula';

--
-- Volcado de datos para la tabla `director`
--

INSERT INTO `director` (`DIR_ID`, `DIR_NOMBRE`) VALUES
(1, 'Stephen Spilberg');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='CD\r\nDVD\r\nVHS';

--
-- Volcado de datos para la tabla `formato`
--

INSERT INTO `formato` (`FOR_ID`, `FOR_NOMBRE`) VALUES
(1, 'DVD');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Romantca\r\nComico\r\nCiencia Ficcion\r\nDeportes';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Datos de Identocación de la Película';

--
-- Volcado de datos para la tabla `pelicula`
--

INSERT INTO `pelicula` (`PEL_ID`, `GEN_ID`, `DIR_ID`, `FOR_ID`, `PEL_NOMBRE`, `PEL_COSTO`, `PEL_FECHA_ESTRENO`) VALUES
(1, 1, 1, 1, 'Titanic', 10.00, '2002-04-06'),
(2, 1, 1, 1, 'YOU', 15.00, '2015-03-05'),
(3, 1, 1, 1, 'Antes de mi', 15.00, '2019-03-05');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Maculino\r\nFemenino';
...
INSERT INTO `socio` (`SOC_ID`, `SOC_CEDULA`, `SOC_NOMBRE`, `SOC_DIRECCION`, `SOC_TELEFONO`, `SOC_CORREO`) VALUES
(1, '1753759404', 'Jose Delgado', 'Latacunga', '0987252611', 'jsdel@gmail.com'),
(2, '0504065103', 'Esteban Villavicencio', 'Latacunga', '0985831512', 'efvillavicencio1@espe.edu.ec'),
(3, '0504065104', 'David Claudio', 'Latacunga', '0985831519', 'edclaudio@espe.edu.ec'),
(4, '0504065105', 'Dennis Tovar', 'Latacunga', '0985831520', 'dgtovar@espe.edu.ec'),
(5, '0504065105', 'Rosa Yupangui', 'Latacunga', '0985831520', 'rgyupangui@espe.edu.ec');
...
--
ALTER TABLE `alquiler`
  MODIFY `ALQ_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `director`
--
ALTER TABLE `director`
  MODIFY `DIR_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `formato`
--
ALTER TABLE `formato`
  MODIFY `FOR_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `genero`
--
ALTER TABLE `genero`
  MODIFY `GEN_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pelicula`
--
ALTER TABLE `pelicula`
  MODIFY `PEL_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `sexo`
--
ALTER TABLE `sexo`
  MODIFY `SEX_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `socio`
--
ALTER TABLE `socio`
  MODIFY `SOC_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=6;
