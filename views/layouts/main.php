...
<header id="header">
    ...
    NavBar::begin([
        ...
        'brandLabel' => Html::img('@web/img/film.png', ['alt' => Yii::$app->name, 'class' => 'logo-img', 'width' => 70]),
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; Estudiantes ISOW <?= date('Y') ?></div>
